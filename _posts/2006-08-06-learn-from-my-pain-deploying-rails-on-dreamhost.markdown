...
<ol>
	<li>Make sure you're starting completely from scratch.  We should have a vanilla domain setup in the <a href="https://panel.dreamhost.com">DH control panel</a> under "Domains > Domain Manager", and no files whatsoever in <code>~/example.com/</code></li>
	...
	<li>Set up your databases in MySQL if you haven't already.  Go to the <a href="https://panel.dreamhost.com">DH control panel</a> and navigate on the sidebar to "Goodies > Manage MySQL".  Then create your database and also create a new hostname ("mysql.example.com").  Note the username (create a new one) and password you use.  Go ahead and create a development, test, and production database so that your migration will work (you are using <a href="https://wiki.rubyonrails.org/rails/pages/UnderstandingMigrations">migrations</a>, right?).</li>
...
and fill in the controller which you want to handle any visits to https://example.com</li>
