...
I'm a bit late mentioning this, but I released another super-beta gem in the hopes it might help another poor soul: [treeoid](https://rubygems.org/gems/treeoid), the missing "acts_as_tree" library for [mongoid](https://mongoid.org). It couldn't be simpler, really: it gives you a "parent" accessor and a "children" collection. On top of that, it provides a scope allowing you to list a set of treeoid objects in hierarchical order, which is perfect for front end integration.
...
This also allows all descendants of a given object to be easily fetched - if the id shows up in the ancestry, return it! It's this kind of out-of-the-box thinking that has really endeared [MongoDB](https://mongodb.org) to me. I hope you can benefit from this and help me improve it. Or help with [greedy](/2010/07/25/announcing-greedy/). I'd love to get said help at [CVREG](https://cvreg.org)'s [upcoming](https://www.cvreg.org/2010/8/9/august-meeting-celebrate-whyday) [Why Day](https://whyday.org/) hackfest.
